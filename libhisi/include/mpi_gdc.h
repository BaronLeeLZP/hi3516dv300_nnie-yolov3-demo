...
/*****************************************************************************
 ...
 Input        : GDC_HANDLE  hHandle
             GDC_TASK_ATTR_S *pstTask
             FISHEYE_ATTR_EX_S* pstFishEyeAttrrEx
             HI_BOOL bCheckMode
 Output       : None
 Return Value :
 Calls        :
...
<$/>
*****************************************************************************/
HI_S32 HI_MPI_GDC_AddCorrectionExTask(GDC_HANDLE hHandle, const GDC_TASK_ATTR_S* pstTask, const FISHEYE_ATTR_EX_S* pstFishEyeAttrrEx, HI_BOOL bCheckMode);
